export default {
  ...
  // ----- // SEND_FORM // ----- //
  SEND_FORM_START: 'SEND_FORM_START',
  SEND_FORM_SUCCESS: 'SEND_FORM_SUCCESS',

  SEND_TRAINING_START: 'SEND_TRAINING_START',
  SEND_TRAINING_SUCCESS: 'SEND_TRAINING_SUCCESS',

  SEND_MUSCLE_TRAINING_START: 'SEND_MUSCLE_TRAINING_START',
  SEND_MUSCLE_TRAINING_SUCCESS: 'SEND_MUSCLE_TRAINING_SUCCESS',
  // -----// CURRENT_USER //-----//
  GET_CURRENT_USER_START: 'GET_CURRENT_USER_START',
  GET_CURRENT_USER_SUCCESS: 'GET_CURRENT_USER_SUCCESS',
  GET_CURRENT_USER_FAILURE: 'GET_CURRENT_USER_FAILURE',
  GET_CURRENT_USER_TRAINS_START: 'GET_CURRENT_USER_TRAINS_START',
  GET_CURRENT_USER_TRAINS_SUCCESS: 'GET_CURRENT_USER_TRAINS_SUCCESS',
  // -----// TRANSACTIONS //-----//
